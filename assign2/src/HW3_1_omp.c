...
// (2) OpenMP version of the pointer-swap heat diffusion program.
// Uses pointer swap instead of memcpy/loop to exchange old and new grids.
//
// To compile: gcc -fopenmp -O2 HW3_1_omp.c -o HW3_1_omp -lm
// To run:     OMP_NUM_THREADS=4 ./HW3_1_omp
//             OMP_NUM_THREADS=4 OMP_SCHEDULE="dynamic,50" ./HW3_1_omp
...
int main(int argc, char** argv) {
    ...
    for (int block = 1; block <= TIMESTEPS; block++) {
        ...
        // Parallelize the stencil computation across rows and columns
